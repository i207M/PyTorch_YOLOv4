...
python detect_server.py --device 2 --names data/${DATA_NAME}/names --cfg data/${DATA_NAME}/${DATA_NAME}.cfg --save-txt --weights pth/${DATA_NAME}.pt --conf-thres 0.4 --iou-thres 0.5 --img 640 --output /home/dlenv/deploy/http-wrapper-lab/yolo_out/
